...
`,
	},
	{
		...
		bnTitle: 'ঢাকার ট্রাফিক আইন, লঙ্ঘন ও জরিমানার তালিকা (২০২৬ গাইড)',
		...
		coverImage: '/blog/ai-traffic-system-dhaka-violations-fines.jpg',
		author: 'KoyJabo Team',
...
`
	},
	{
		...
		title: 'How to Travel in Dhaka: Transport Guide for Tourists (2026)',
		bnTitle: 'কিভাবে ঢাকায় যাতায়াত করবেন: পর্যটকদের জন্য ট্রান্সপোর্ট গাইড (২০২৬)',
		excerpt: 'Everything you need to know about transport in Dhaka — buses, metro rail, rickshaws, CNGs, ride-hailing apps, and how to navigate the city like a local.',
		bnExcerpt: 'ঢাকায় যাতায়াতের সব তথ্য এক জায়গায় — বাস, মেট্রো, রিকশা, সিএনজি, রাইড-হেইলিং অ্যাপ এবং কীভাবে শহরটি চেনা মানুষের মতো চলতে পারবেন।',
		coverImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b1/Drone_view_from_Kamal_Atat%C3%BCrk_Avenue.jpg/960px-Drone_view_from_Kamal_Atat%C3%BCrk_Avenue.jpg',
		author: 'KoyJabo Team',
		publishDate: '2026-04-28',
		readTime: '8 min read',
		keywords: [
			'how to get around Dhaka', 'Dhaka transportation guide', 'Dhaka transport 2026',
			'getting around Bangladesh', 'Dhaka bus guide', 'Dhaka metro rail',
			'rickshaw Dhaka', 'CNG auto rickshaw Bangladesh', 'ride hailing Dhaka',
			'Pathao Dhaka', 'Shohoz Dhaka', 'Uber Dhaka', 'Dhaka travel tips for tourists',
			'Bangladesh travel guide', 'Dhaka expat guide', 'KoyJabo app',
			'public transport Dhaka', 'how to travel Dhaka cheaply'
		],
...
`
	...
	{
		id: 'dhaka-metro-rail-mrt-line-6-complete-guide',
		slug: 'dhaka-metro-rail-mrt-line-6-complete-guide',
		title: 'Dhaka Metro Rail MRT Line 6 Guide: Route, Ticket & Timing',
		bnTitle: 'ঢাকা মেট্রোরেল এমআরটি লাইন ৬ গাইড: রুট, টিকিট ও সময়সূচী',
		excerpt: 'Everything about Dhaka\'s MRT Line 6 — all stations, fares, operating hours, MRT Pass card, tips for first-time riders, and how it connects to buses and other transport.',
		bnExcerpt: 'ঢাকার মেট্রোরেল সম্পর্কে সব কিছু — স্টেশন, ভাড়া, সময়সূচি, এমআরটি পাস কার্ড এবং প্রথমবার যাত্রীদের জন্য টিপস।',
		coverImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/MRT_Line_6_train_%28cropped%29.jpg/960px-MRT_Line_6_train_%28cropped%29.jpg',
		author: 'KoyJabo Team',
		publishDate: '2026-04-27',
		readTime: '6 min read',
		keywords: [
			'Dhaka Metro Rail guide', 'MRT Line 6 Bangladesh', 'Dhaka metro stations',
			'metro fare Dhaka', 'MRT Pass Dhaka', 'Uttara to Motijheel metro',
			'ঢাকা মেট্রোরেল', 'মেট্রো ভাড়া', 'MRT card Dhaka',
			'metro rail schedule Bangladesh', 'Dhaka rapid transit', 'metro etiquette Bangladesh',
			'Dhaka commute metro', 'KoyJabo metro guide', 'public transport Bangladesh'
		],
		category: 'Metro Rail',
		content: `
...
`
	...
	{
		id: 'dhaka-to-coxs-bazar-travel-guide',
		slug: 'dhaka-to-coxs-bazar-travel-guide',
		title: 'Dhaka to Cox’s Bazar Travel Cost, Bus & Train Guide (2026)',
		bnTitle: 'ঢাকা থেকে কক্সবাজার ভ্রমণের খরচ, বাস ও ট্রেন গাইড (২০২৬)',
		excerpt: 'Planning a trip from Dhaka to Cox\'s Bazar? Here\'s every option — overnight buses, the new train route, and budget flights — with fares, duration, and tips to make the journey smooth.',
		bnExcerpt: 'ঢাকা থেকে কক্সবাজার যাওয়ার সব উপায় — নাইটকোচ বাস, ট্রেন এবং বিমান। ভাড়া, সময় এবং সেরা টিপস সহ।',
		coverImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/A_dusk_at_Cox%27s_Bazar_sea_beach.jpg/960px-A_dusk_at_Cox%27s_Bazar_sea_beach.jpg',
		author: 'KoyJabo Team',
		publishDate: '2026-04-26',
		readTime: '7 min read',
		keywords: [
			'Dhaka to Cox\'s Bazar bus', 'Dhaka to Coxs Bazar travel guide',
			'Cox\'s Bazar transport guide', 'overnight bus Dhaka Coxs Bazar',
			'Dhaka Coxs Bazar train', 'Dhaka Coxs Bazar flight', 'Coxs Bazar travel tips',
			'ঢাকা থেকে কক্সবাজার', 'কক্সবাজার বাস ভাড়া', 'Bangladesh beach travel',
			'Cox\'s Bazar tourism', 'KoyJabo travel guide', 'Bangladesh travel 2026',
			'Sayedabad bus terminal', 'Green Line bus Dhaka'
		],
		category: 'Travel Guide',
		content: `
...
`
	...
	{
		id: 'dhaka-to-chittagong-travel-guide',
		slug: 'dhaka-to-chittagong-travel-guide',
		title: 'Dhaka to Chittagong: Complete Travel Guide 2026',
		bnTitle: 'ঢাকা থেকে চট্টগ্রাম: সম্পূর্ণ ট্রাভেল গাইড ২০২৬',
		excerpt: 'Dhaka to Chittagong by bus, train, or flight — fares, journey times, best options for different budgets, and what to expect on Bangladesh\'s busiest intercity route.',
		bnExcerpt: 'ঢাকা থেকে চট্টগ্রাম বাস, ট্রেন বা বিমানে — ভাড়া, সময়, এবং বাংলাদেশের সবচেয়ে ব্যস্ত রুটে কী আশা করতে পারেন।',
		coverImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/Agrabad_Commercial_Area.jpg/960px-Agrabad_Commercial_Area.jpg',
		author: 'KoyJabo Team',
		publishDate: '2026-04-25',
		readTime: '6 min read',
		keywords: [
			'Dhaka to Chittagong bus', 'Dhaka Chittagong travel guide',
			'ঢাকা চট্টগ্রাম বাস ভাড়া', 'Dhaka Chittagong train',
			'Dhaka Chittagong flight', 'Chittagong travel Bangladesh',
			'Shonarbangla train Dhaka', 'Green Line Dhaka Chittagong',
			'Bangladesh intercity bus', 'KoyJabo Chittagong guide',
			'Sayedabad to Chittagong', 'Subarna Express train'
		],
		category: 'Travel Guide',
		content: `
...
`
	...
	{
		id: 'how-to-use-koyjabo-app',
		slug: 'how-to-use-koyjabo-app',
		title: 'How to Use KoyJabo: Bangladesh\'s #1 Transport Planner',
		bnTitle: 'কই যাবো কীভাবে ব্যবহার করবেন: বাংলাদেশের সেরা ট্রান্সপোর্ট প্ল্যানার',
		excerpt: 'KoyJabo (কই যাবো) helps you find bus routes, check fares, and plan journeys across Bangladesh. Here\'s a complete guide to every feature — bus search, metro guide, train finder, and more.',
		bnExcerpt: 'কই যাবো দিয়ে ঢাকার বাস রুট খুঁজুন, ভাড়া দেখুন এবং সারা বাংলাদেশে যাত্রা পরিকল্পনা করুন। এখানে প্রতিটি ফিচারের সম্পূর্ণ গাইড।',
		coverImage: '/blog/how-to-use-koyjabo-app.jpg',
		author: 'KoyJabo Team',
		publishDate: '2026-04-24',
		readTime: '5 min read',
		keywords: [
			'KoyJabo app guide', 'কই যাবো অ্যাপ', 'Bangladesh transport app',
			'Dhaka bus route finder', 'how to find bus route Dhaka',
			'best app for Dhaka transport', 'koyjabo.com guide',
			'Bangladesh public transport app', 'Dhaka route planner',
			'find bus in Dhaka', 'Dhaka commuter app', 'transit app Bangladesh',
			'KoyJabo features', 'offline transport app Bangladesh'
		],
		category: 'App Guide',
		content: `
...
`
	...
	{
		id: 'best-bus-routes-dhaka-commuter-guide',
		slug: 'best-bus-routes-dhaka-commuter-guide',
		title: 'Best Bus Routes in Dhaka: The Daily Commuter\'s Guide',
		bnTitle: 'ঢাকার সেরা বাস রুট: দৈনন্দিন যাত্রীদের গাইড',
		excerpt: 'A practical guide to the most important bus routes in Dhaka — covering major corridors like Mirpur–Motijheel, Uttara–Gulshan, Dhanmondi–Paltan, and how to find any route using KoyJabo.',
		bnExcerpt: 'ঢাকার সবচেয়ে গুরুত্বপূর্ণ বাস রুটের ব্যবহারিক গাইড — মিরপুর–মতিঝিল, উত্তরা–গুলশান, ধানমন্ডি–পল্টন এবং কীভাবে KoyJabo দিয়ে যেকোনো রুট খুঁজবেন।',
		coverImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c6/BRTC_Ashok_Leyland_Titan_double-decker%2CBangladesh_%2830825844661%29.jpg/960px-BRTC_Ashok_Leyland_Titan_double-decker%2CBangladesh_%2830825844661%29.jpg',
		author: 'KoyJabo Team',
		publishDate: '2026-04-23',
		readTime: '5 min read',
		keywords: [
			'Dhaka bus routes', 'best bus Dhaka', 'Dhaka city bus guide',
			'Mirpur to Motijheel bus', 'Uttara to Gulshan bus', 'Dhanmondi bus route',
			'ঢাকা বাস রুট', 'ঢাকা সিটি বাস', 'KoyJabo bus guide',
			'public bus Dhaka 2026', 'BRTC Dhaka', 'bus number Dhaka',
			'Dhaka commute guide', 'daily commute Dhaka transport'
		],
...
`
	...
	{
		id: 'dhaka-to-sylhet-travel-guide',
		slug: 'dhaka-to-sylhet-travel-guide',
		title: 'Dhaka to Sylhet: Bus, Train & Complete Travel Guide',
		bnTitle: 'ঢাকা থেকে সিলেট: বাস, ট্রেন ও সম্পূর্ণ ট্রাভেল গাইড',
		excerpt: 'Planning a trip to Sylhet — the land of tea gardens, Ratargul swamp forest, and the Jaflong hills? Here\'s the full guide on buses, trains, fares, and what to see.',
		bnExcerpt: 'সিলেট ভ্রমণ পরিকল্পনা করছেন — চা বাগান, রাতারগুল, জাফলং-এর দেশে? বাস, ট্রেন, ভাড়া এবং দর্শনীয় স্থানের সম্পূর্ণ গাইড।',
		coverImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/Sylhet_city_02.jpg/960px-Sylhet_city_02.jpg',
		author: 'KoyJabo Team',
		publishDate: '2026-04-22',
		readTime: '6 min read',
		keywords: [
			'Dhaka to Sylhet bus', 'Dhaka Sylhet travel guide', 'ঢাকা থেকে সিলেট',
			'Sylhet travel Bangladesh', 'Sylhet bus fare 2026', 'ঢাকা সিলেট ট্রেন',
			'Parabat Express Sylhet', 'tea garden Sylhet guide', 'Ratargul swamp forest',
			'Jaflong Bangladesh', 'Sylhet tourism', 'Shyamoli Sylhet bus',
			'KoyJabo Sylhet guide', 'Bangladesh travel Sylhet'
		],
		category: 'Travel Guide',
		content: `
...
`
	...
	{
		id: 'rickshaw-cng-guide-dhaka',
		slug: 'rickshaw-cng-guide-dhaka',
		title: 'Rickshaw & CNG Auto-Rickshaw in Dhaka: The Essential Guide',
		bnTitle: 'ঢাকায় রিকশা ও সিএনজি: প্রয়োজনীয় গাইড',
		excerpt: 'Rickshaws and CNG auto-rickshaws are uniquely Dhaka. Here\'s how to use them, what to pay, how to negotiate, and when they\'re the best option — for locals and visitors alike.',
		bnExcerpt: 'রিকশা ও সিএনজি ঢাকার অনন্য পরিচয়। কীভাবে ব্যবহার করবেন, কত দিতে হবে, কীভাবে দামাদামি করবেন — স্থানীয় এবং দর্শনার্থী উভয়ের জন্য।',
		coverImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/eb/%E0%A6%85%E0%A6%9F%E0%A7%8B%E0%A6%B0%E0%A6%BF%E0%A6%95%E0%A6%B6%E0%A6%BE.jpg/960px-%E0%A6%85%E0%A6%9F%E0%A7%8B%E0%A6%B0%E0%A6%BF%E0%A6%95%E0%A6%B6%E0%A6%BE.jpg',
		author: 'KoyJabo Team',
		publishDate: '2026-04-21',
		readTime: '4 min read',
		keywords: [
			'rickshaw Dhaka guide', 'CNG auto rickshaw Dhaka', 'Dhaka transport for tourists',
			'rickshaw price Dhaka', 'CNG fare Dhaka', 'how to use CNG Bangladesh',
			'ঢাকা রিকশা', 'ঢাকা সিএনজি ভাড়া', 'তিন চাকার গাড়ি ঢাকা',
			'Dhaka local transport', 'negotiate fare Bangladesh', 'cycle rickshaw Bangladesh',
			'Dhaka tourist transport', 'Old Dhaka rickshaw'
		],
		category: 'Travel Guide',
		content: `
...
`
	...
	{
		id: 'budget-travel-bangladesh-transport-tips',
		slug: 'budget-travel-bangladesh-transport-tips',
		title: 'Budget Travel in Bangladesh: How to Get Around for Less',
		bnTitle: 'বাজেটে বাংলাদেশ ভ্রমণ: কম খরচে যাতায়াতের উপায়',
		excerpt: 'Bangladesh is one of the most affordable countries to travel in Asia. Here\'s how to get around the country on a tight budget — from cheap buses and trains to free walking routes.',
		bnExcerpt: 'বাংলাদেশ এশিয়ার সবচেয়ে সাশ্রয়ী দেশগুলোর একটি। কম খরচে কীভাবে সারাদেশ ঘুরবেন — সস্তা বাস থেকে ট্রেন এবং হাঁটার রুট পর্যন্ত।',
		coverImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Dhaka_-_Taxi_boats_and_ferry_on_Buriganga_River.jpg/960px-Dhaka_-_Taxi_boats_and_ferry_on_Buriganga_River.jpg',
		author: 'KoyJabo Team',
		publishDate: '2026-04-20',
		readTime: '6 min read',
		keywords: [
			'budget travel Bangladesh', 'cheap transport Bangladesh',
			'how to travel Bangladesh cheaply', 'Bangladesh backpacker guide',
			'low cost travel Dhaka', 'cheap bus Bangladesh', 'train travel Bangladesh budget',
			'Bangladesh travel tips', 'travel on budget Asia', 'backpacking Bangladesh',
			'affordable Bangladesh travel', 'KoyJabo budget travel',
			'non-AC bus Bangladesh', 'ferry travel Bangladesh'
		],
		category: 'Travel Guide',
		content: `
...
`
	...
	{
		id: 'dhaka-traffic-tips-beat-rush-hour',
		slug: 'dhaka-traffic-tips-beat-rush-hour',
		title: 'Dhaka Traffic: 10 Tips to Beat Rush Hour and Save Hours Every Week',
		bnTitle: 'ঢাকার ট্রাফিক: রাশ আওয়ার এড়ানোর ১০টি টিপস এবং প্রতি সপ্তাহে ঘণ্টা বাঁচান',
		excerpt: 'Dhaka traffic is legendary. But commuters who understand the patterns, the shortcuts, and the right tools save hours every week. Here are 10 proven strategies.',
		bnExcerpt: 'ঢাকার ট্রাফিক কুখ্যাত। কিন্তু যারা প্যাটার্ন, শর্টকাট এবং সঠিক টুল জানেন তারা প্রতি সপ্তাহে ঘণ্টার পর ঘণ্টা বাঁচান। এখানে ১০টি প্রমাণিত কৌশল।',
		coverImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4f/Cycle_Rickshaws_-_High_Court_Street_-_Dhaka_2015-05-31_2095.JPG/960px-Cycle_Rickshaws_-_High_Court_Street_-_Dhaka_2015-05-31_2095.JPG',
		author: 'KoyJabo Team',
		publishDate: '2026-04-19',
		readTime: '5 min read',
		keywords: [
			'Dhaka traffic tips', 'beat Dhaka rush hour', 'Dhaka commute hack',
			'avoid traffic Dhaka', 'Dhaka travel time saving', 'ঢাকা ট্রাফিক',
...
`
	},
	{
		...
		coverImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Female_coach_in_Bangladesh_Railway.jpg/960px-Female_coach_in_Bangladesh_Railway.jpg',
		content: `
...
`,
	...
	},
	{
		...
		bnExcerpt: 'মেট্রোরেল শুধু যাত্রা দ্রুত করেনি, এনেছে একটি নতুন ট্রান্সপোর্ট কালচার। ছোট ছোট অভ্যাস কীভাবে পুরো শহরের অভিজ্ঞতা বদলে দিতে পারে।',
		coverImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b1/Metro_Rail_Station_at_Uttara_Center_in_Dhaka%2C_Bangladesh.jpg/960px-Metro_Rail_Station_at_Uttara_Center_in_Dhaka%2C_Bangladesh.jpg',
		content: `
...
`,
	...
	{
		id: 'best-places-to-visit-in-bangladesh-2026-guide',
		slug: 'best-places-to-visit-in-bangladesh-2026-guide',
		title: 'Best Places to Visit in Bangladesh (2026 Tourist Guide)',
		bnTitle: 'বাংলাদেশে ভ্রমণের সেরা জায়গাগুলো (২০২৬ ট্যুরিস্ট গাইড)',
		excerpt: 'Explore the hidden gems of Bangladesh — from the world\'s largest mangrove forest to the longest sea beach. Here are the must-visit places for your next trip.',
		bnExcerpt: 'বাংলাদেশের লুকিয়ে থাকা সৌন্দর্যগুলো খুঁজে দেখুন — পৃথিবীর বৃহত্তম ম্যানগ্রোভ বন থেকে দীর্ঘতম সমুদ্র সৈকত। আপনার পরবর্তী ট্যুরের জন্য সেরা জায়গাগুলোর তালিকা।',
		...
		keywords: [
			'best places to visit in Bangladesh', 'Bangladesh tourism 2026',
			'visit Sundarbans', 'Cox\'s Bazar beach guide', 'Sylhet tea gardens',
			'Srimangal travel', 'Bandarban hiking', 'Saint Martin island',
			'places to visit in Dhaka', 'Bangladesh travel tips', 'KoyJabo travel guide'
		],
		category: 'Travel Guide',
		content: `
...
`
	...
	{
		id: 'cheap-travel-guide-dhaka-to-coxs-bazar-save-money',
		slug: 'cheap-travel-guide-dhaka-to-coxs-bazar-save-money',
		title: 'Dhaka to Cox’s Bazar Budget Travel Guide: Save Money (2026)',
		bnTitle: 'ঢাকা থেকে কক্সবাজার বাজেটে ভ্রমণের গাইড: টাকা বাঁচান (২০২৬)',
		excerpt: 'Want to visit Cox\'s Bazar without breaking the bank? Learn how to find cheap buses, budget hotels, and affordable food for your next beach trip.',
		bnExcerpt: 'বেশি খরচ না করে কক্সবাজার ঘুরতে চান? কিভাবে কম ভাড়ায় বাস, সস্তা হোটেল এবং সাশ্রয়ী খাবার পাবেন তা জানুন।',
		coverImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Cox%27s_Bazar_Beach_Crowd.jpg/1024px-Cox%27s_Bazar_Beach_Crowd.jpg',
		author: 'KoyJabo Team',
		publishDate: '2026-05-01',
		readTime: '8 min read',
		keywords: [
			'cheap travel Cox\'s Bazar', 'budget trip Dhaka to Coxs Bazar',
			'Cox\'s Bazar low cost guide', 'cheap hotels Coxs Bazar',
			'budget food Coxs Bazar', 'how to save money in Bangladesh trip',
			'KoyJabo budget guide', 'travel hacks Bangladesh'
		],
		category: 'Travel Guide',
		content: `
...
`
	...
	{
		id: 'bangladesh-tour-cost-breakdown-2026',
		slug: 'bangladesh-tour-cost-breakdown-2026',
		title: 'Bangladesh Tour Cost Breakdown: How Much Money Do You Need?',
		bnTitle: 'বাংলাদেশ ট্যুর খরচ: আপনার কত টাকা লাগবে? (২০২৬ আপডেট)',
		excerpt: 'Planning a trip around Bangladesh? Here is a complete breakdown of daily costs for transport, food, accommodation, and activities for all budgets.',
		bnExcerpt: 'সারা বাংলাদেশ ঘুরে দেখার পরিকল্পনা করছেন? যাতায়াত, খাবার, থাকা এবং অন্যান্য খরচের একটি পূর্ণাঙ্গ হিসাব এখানে পাবেন।',
		coverImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Taka_Banknote.jpg/1024px-Taka_Banknote.jpg',
		author: 'KoyJabo Team',
		publishDate: '2026-04-30',
		readTime: '7 min read',
		keywords: [
			'Bangladesh travel cost', 'daily budget Bangladesh', 'price of food Bangladesh',
...
`
	...
	{
		id: 'bangladesh-railway-senior-citizen-disability-fare-discount-2026',
		slug: 'bangladesh-railway-senior-citizen-disability-fare-discount-2026',
		title: 'Bangladesh Railway 25% Fare Discount: Senior Citizens & Disabled Passengers Guide (2026)',
		bnTitle: 'বাংলাদেশ রেলওয়েতে ২৫% ভাড়া ছাড়: প্রবীণ ও প্রতিবন্ধী যাত্রীদের সম্পূর্ণ গাইড (২০২৬)',
		excerpt: 'Bangladesh Railway now offers 25% fare discount for passengers aged 65+ and holders of the Suborno disability card. Effective from 25 May 2026, available both online and at counters. Here\'s how to claim it.',
		bnExcerpt: '২৫ মে ২০২৬ থেকে বাংলাদেশ রেলওয়েতে ৬৫ বছর বা তদূর্ধ্ব যাত্রী এবং সুবর্ণ কার্ডধারী প্রতিবন্ধী যাত্রীদের জন্য ২৫% ভাড়া ছাড় কার্যকর। অনলাইন ও কাউন্টার উভয় মাধ্যমেই পাওয়া যাবে।',
		coverImage: 'https://media.licdn.com/dms/image/v2/D5622AQGu2OcR20uvJw/feedshare-shrink_1280/B56Z68egKoJQAM-/0/1781278573550?e=1782950400&v=beta&t=uzo4wP2_peEuT6ihcQXRZgcHWhWhK3l8meXywgZqgTU',
		author: 'KoyJabo Team',
		publishDate: '2026-06-12',
		readTime: '5 min read',
		keywords: [
			'Bangladesh Railway fare discount 2026', 'senior citizen train discount Bangladesh',
			'railway discount 65 years Bangladesh', 'Suborno card disability discount train',
			'বাংলাদেশ রেলওয়ে ভাড়া ছাড়', 'প্রবীণ ট্রেন ছাড়', 'সুবর্ণ কার্ড রেলওয়ে',
			'disabled passenger train Bangladesh', 'inclusive transport Bangladesh',
			'railway NID verification discount', 'train ticket discount Bangladesh',
			'Bangladesh Railway gazette 2026', 'KoyJabo train guide', 'railway concession Bangladesh'
		],
