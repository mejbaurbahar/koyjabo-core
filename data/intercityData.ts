...
export const INTERCITY_BUS_ROUTES: IntercityBusRoute[] = [
    ...
    { district: "Cox's Bazar", division: "Chattogram", busOperators: ["Shohagh Paribahan", "Shyamoli Paribahan", "Hanif Enterprise", "Soudia Coach Service", "Saintmartin Hyundai (Robi Express)", "Evergreen Transport", "Royal Cox Service", "Sultana Travels", "London Express", "Royal Coach"], mainContactNumber: "01762-691341", route: "Dhaka ⇄ Cox's Bazar", costNonAC: "৳1,000-৳1,100", costAC: "৳1,400-৳2,900" },
    { district: "Cumilla", division: "Chattogram", busOperators: ["Tisha Plus", "Asia Line", "Ena Transport", "Prince"], mainContactNumber: "01711-386408", route: "Dhaka (Sayedabad) ⇄ Cumilla", costNonAC: "৳350", costAC: "৳500" },
    { district: "Brahmanbaria", division: "Chattogram", busOperators: ["Tisha", "Ena Transport", "Royal"], mainContactNumber: "01711-386408", route: "Dhaka ⇄ Brahmanbaria", costNonAC: "৳350", costAC: "৳500" },
    ...
    { district: "Bandarban", division: "Chattogram", busOperators: ["Shyamoli Paribahan", "Saintmartin Hyundai", "Hanif Enterprise (Volvo)", "Soudia Coach"], mainContactNumber: "01762-691341", route: "Dhaka ⇄ Bandarban", costNonAC: "৳850", costAC: "৳1,300-৳1,400" },

    // Rajshahi Division (8 Districts) — Akota & KTC Hanif confirmed by Shohoz
    { district: "Rajshahi", division: "Rajshahi", busOperators: ["Akota Transport", "KTC Hanif", "Hanif Enterprise", "Rohonpur Travels", "Evergreen Transport", "Desh Travels", "National Travels", "BRTC"], mainContactNumber: "01762-684433", route: "Dhaka (Mohakhali/Gabtoli) ⇄ Rajshahi", costNonAC: "৳730", costAC: "৳850-৳1,300" },
    { district: "Chapai Nawabganj", division: "Rajshahi", busOperators: ["Hanif Enterprise", "KTC Hanif", "Desh Travels", "Modern", "Grameen"], mainContactNumber: "01762-684433", route: "Dhaka ⇄ Chapai Nawabganj", costNonAC: "৳800", costAC: "৳1,200-৳1,500" },
    { district: "Natore", division: "Rajshahi", busOperators: ["Akota Transport", "Desh Travels", "Hanif Enterprise", "National Travels"], mainContactNumber: "01713-402641", route: "Dhaka ⇄ Natore", costNonAC: "৳600", costAC: "৳950-৳1,200" },
    { district: "Naogaon", division: "Rajshahi", busOperators: ["S.R Travels", "Manik Express", "Hanif Enterprise", "Agomony Express"], mainContactNumber: "01716-560641", route: "Dhaka ⇄ Naogaon", costNonAC: "৳650", costAC: "৳1,000-৳1,300" },
    { district: "Pabna", division: "Rajshahi", busOperators: ["Pabna Express", "C-Line", "Hanif Enterprise", "Sarkar"], mainContactNumber: "01750-143092", route: "Dhaka ⇄ Pabna", costNonAC: "৳550", costAC: "৳800" },
    { district: "Sirajganj", division: "Rajshahi", busOperators: ["Akota Transport", "SI Enterprise", "Sirajganj Express", "Hanif Enterprise"], mainContactNumber: "01713-402641", route: "Dhaka ⇄ Sirajganj", costNonAC: "৳450", costAC: "৳700" },
    { district: "Bogura", division: "Rajshahi", busOperators: ["Shyamoli Paribahan", "Rongdhonu Express", "Hanif Enterprise", "Manik Express", "Orin Travels", "S.R Travels", "Heritage Express", "DR Enterprise", "Akota Transport", "Nabil Paribahan", "Blue Line Express", "Agomony Express"], mainContactNumber: "01716-560641", route: "Dhaka (Gabtoli/Mohakhali) ⇄ Bogura", costNonAC: "৳480-৳580", costAC: "৳800-৳1,600" },
    { district: "Joypurhat", division: "Rajshahi", busOperators: ["Hanif Enterprise", "S.R Travels", "Shyamoli Paribahan", "Blue Line Express"], mainContactNumber: "01713-402641", route: "Dhaka ⇄ Joypurhat", costNonAC: "৳600", costAC: "৳1,000-৳1,200" },

    // Khulna Division (10 Districts) — operators confirmed from Shohoz
    ...
    { district: "Bagerhat", division: "Khulna", busOperators: ["Dola Paribahan", "Diganta Paribahan", "Hanif Enterprise", "Comfort Line"], mainContactNumber: "01711-266512", route: "Dhaka ⇄ Bagerhat", costNonAC: "৳650-৳680", costAC: "৳1,000" },
    { district: "Satkhira", division: "Khulna", busOperators: ["Satkhira Line", "Jamuna Line Paribahan", "Shohagh Paribahan", "Tungipara Express", "Emad Paribahan", "Master Travels", "Hanif Enterprise", "S. Alam Service", "Star Deluxe"], mainContactNumber: "01711-357833", route: "Dhaka ⇄ Satkhira", costNonAC: "৳700-৳820", costAC: "৳920-৳1,000" },
    { district: "Jashore", division: "Khulna", busOperators: ["Shohagh Paribahan", "Hanif Enterprise", "Royal Coach", "Royal Maitri Service", "Star Deluxe", "Green Line", "Eagle"], mainContactNumber: "16557", route: "Dhaka ⇄ Jashore", costNonAC: "৳600-৳750", costAC: "৳850-৳1,700" },
    { district: "Jhenaidah", division: "Khulna", busOperators: ["Royal Express", "Hanif Enterprise", "Purbasha", "Chuadanga Deluxe"], mainContactNumber: "01711-350616", route: "Dhaka (Abdullahpur/Sayedabad) ⇄ Jhenaidah", costNonAC: "৳700-৳750", costAC: "৳900-৳1,400" },
    { district: "Magura", division: "Khulna", busOperators: ["Shohagh Paribahan", "Hanif Enterprise", "Diganta Paribahan", "Eagle"], mainContactNumber: "01713-402641", route: "Dhaka ⇄ Magura", costNonAC: "৳550", costAC: "৳900" },
    { district: "Narail", division: "Khulna", busOperators: ["Shohagh Paribahan", "Hanif Enterprise", "Eagle Paribahan", "Arnob"], mainContactNumber: "01711-4022341", route: "Dhaka ⇄ Narail", costNonAC: "৳550", costAC: "৳900" },
    { district: "Kushtia", division: "Khulna", busOperators: ["SB Super Deluxe", "Shyamoli Paribahan", "Hanif Enterprise"], mainContactNumber: "01712-230983", route: "Dhaka ⇄ Kushtia", costNonAC: "৳600", costAC: "৳900+" },
    { district: "Chuadanga", division: "Khulna", busOperators: ["Royal Express", "Purbasha", "Darshana Deluxe"], mainContactNumber: "01711-350616", route: "Dhaka ⇄ Chuadanga", costNonAC: "৳700", costAC: "৳1,100" },
    { district: "Meherpur", division: "Khulna", busOperators: ["Royal Express", "Meherpur Deluxe", "JR Paribahan"], mainContactNumber: "01711-350616", route: "Dhaka ⇄ Meherpur", costNonAC: "৳700-৳750", costAC: "৳1,100" },

    // Barishal Division (6 Districts) — LABIBA Classic confirmed by Shohoz
    { district: "Barishal", division: "Barishal", busOperators: ["LABIBA Classic", "Shyamoli Paribahan", "Shohagh Paribahan", "Ena Transport", "Emad Paribahan", "Hanif Enterprise", "Sakura", "Soudia Coach Service"], mainContactNumber: "01729-556677", route: "Dhaka (Abdullahpur/Sayedabad/Gabtoli) ⇄ Barishal", costNonAC: "৳550-৳700", costAC: "৳850-৳1,250" },
    { district: "Bhola", division: "Barishal", busOperators: ["Bhola Paribahan", "Green St. Martin", "Hanif Enterprise"], mainContactNumber: "01762-691341", route: "Dhaka ⇄ Bhola (bus+launch or direct)", costNonAC: "৳600", costAC: "৳800" },
    { district: "Jhalokathi", division: "Barishal", busOperators: ["LABIBA Classic", "Sakura", "Hanif Enterprise", "Sugandha"], mainContactNumber: "01729-556677", route: "Dhaka ⇄ Jhalokathi", costNonAC: "৳600", costAC: "৳900" },
    { district: "Pirojpur", division: "Barishal", busOperators: ["LABIBA Classic", "Imad Paribahan", "Dola Paribahan", "Tungipara Express"], mainContactNumber: "01711-266512", route: "Dhaka ⇄ Pirojpur", costNonAC: "৳600", costAC: "৳900" },
    { district: "Patukhali", division: "Barishal", busOperators: ["LABIBA Classic", "Ena Transport", "Sakura", "Green Line", "Kuakata Express"], mainContactNumber: "16557", route: "Dhaka ⇄ Patuakhali", costNonAC: "৳590-৳650", costAC: "৳1,000" },
    { district: "Barguna", division: "Barishal", busOperators: ["LABIBA Classic", "Sakura", "Hanif Enterprise", "Abdullah"], mainContactNumber: "01729-556677", route: "Dhaka ⇄ Barguna", costNonAC: "৳650-৳700", costAC: "৳1,000" },
    ...
    // Rangpur Division (8 Districts) — Rongdhonu/Shyamoli/Hanif confirmed, NOT Shohagh
    { district: "Rangpur", division: "Rangpur", busOperators: ["Shyamoli Paribahan", "Rongdhonu Express", "Hanif Enterprise", "Nabil Paribahan", "S.R Travels", "Orin Travels", "Heritage Express", "46 Express", "Shah Ali Paribahan", "Manik Express", "Agomony Express", "BRTC"], mainContactNumber: "01985-555554", route: "Dhaka (Gabtoli/Kalyanpur/Mohakhali) ⇄ Rangpur", costNonAC: "৳750-৳880", costAC: "৳1,000-৳1,700" },
    { district: "Dinajpur", division: "Rangpur", busOperators: ["Shyamoli Paribahan", "Hanif Enterprise", "Nabil Paribahan", "S.R Travels", "Rahbar Enterprise", "Arafat Paribahan", "Heritage Express", "46 Express", "Minister Travels", "BRTC"], mainContactNumber: "01193-106611", route: "Dhaka ⇄ Dinajpur", costNonAC: "৳700-৳970", costAC: "৳1,200-৳1,700" },
    { district: "Thakurgaon", division: "Rangpur", busOperators: ["Hanif Enterprise", "Nabil Paribahan", "Shah Ali Paribahan", "46 Express", "Minister Travels", "BRTC"], mainContactNumber: "01193-106611", route: "Dhaka ⇄ Thakurgaon", costNonAC: "৳950-৳1,050", costAC: "৳1,300-৳1,800" },
    { district: "Panchagarh", division: "Rangpur", busOperators: ["Hanif Enterprise", "Nabil Paribahan", "Shah Ali Paribahan", "BRTC"], mainContactNumber: "01193-106611", route: "Dhaka ⇄ Panchagarh", costNonAC: "৳1,000", costAC: "৳1,400-৳1,800" },
    { district: "Nilphamari", division: "Rangpur", busOperators: ["Nabil Paribahan", "Shalki Classic", "S.R Travels", "Hanif Enterprise", "BRTC"], mainContactNumber: "01985-555554", route: "Dhaka ⇄ Nilphamari", costNonAC: "৳850-৳1,000", costAC: "৳1,200-৳1,600" },
    { district: "Kurigram", division: "Rangpur", busOperators: ["Nabil Paribahan", "Hanif Enterprise", "S.R Travels", "Shah Ali Paribahan"], mainContactNumber: "01713-402641", route: "Dhaka ⇄ Kurigram", costNonAC: "৳850", costAC: "৳1,200-৳1,500" },
    { district: "Lalmonirhat", division: "Rangpur", busOperators: ["Nabil Paribahan", "Hanif Enterprise", "S.R Travels", "Shah Ali Paribahan", "Barkat Travels"], mainContactNumber: "01716-560641", route: "Dhaka ⇄ Lalmonirhat", costNonAC: "৳850", costAC: "৳1,100-৳1,500" },
    { district: "Gaibandha", division: "Rangpur", busOperators: ["Al Hamra Paribahan", "S.R Travels", "Hanif Enterprise", "Orin Travels"], mainContactNumber: "01716-560641", route: "Dhaka ⇄ Gaibandha", costNonAC: "৳700", costAC: "৳1,000-৳1,200" },

    // Mymensingh Division (4 Districts) — Shohagh NOT confirmed
    { district: "Mymensingh", division: "Mymensingh", busOperators: ["Ena Transport", "Soukhin", "Alam Asia", "Hanif Enterprise", "BRTC"], mainContactNumber: "01712-069722", route: "Dhaka (Mohakhali) ⇄ Mymensingh", costNonAC: "৳350", costAC: "৳500-৳700" },
    { district: "Jamalpur", division: "Mymensingh", busOperators: ["Rajib", "Ena Transport", "Mahanagar", "Hanif Enterprise"], mainContactNumber: "01712-069722", route: "Dhaka ⇄ Jamalpur", costNonAC: "৳450", costAC: "৳700" },
    { district: "Sherpur", division: "Mymensingh", busOperators: ["Sonar Bangla", "Ena Transport", "Dreamland"], mainContactNumber: "01712-069722", route: "Dhaka ⇄ Sherpur", costNonAC: "৳450", costAC: "৳700" },
    { district: "Netrokona", division: "Mymensingh", busOperators: ["Mohua", "Shahjalal", "Ena Transport"], mainContactNumber: "01712-069722", route: "Dhaka ⇄ Netrokona", costNonAC: "৳450", costAC: "৳700" },
];
