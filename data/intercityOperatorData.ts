...
export const BUS_OPERATOR_DETAILS: BusOperatorDetail[] = [
  ...
  // ── BANGLA STAR ─────────────────────────────────────────────────────────────
  {
    ...
    headquarters: 'Dhaka',
    fleetSize: '30+',
    busTypes: ['Hino-1J Non-AC', 'AC Premium Sleeper', 'AC RM-2'],
    coverage: 'Dhaka ⇄ Pabna via Sirajganj/Baghabari',
    routes: [
      {
        id: 'dhaka_pabna',
        from: 'Dhaka', fromBn: 'ঢাকা',
        to: 'Pabna', toBn: 'পাবনা',
        fareNonAC: "৳600", fareAC: "৳800",
        durationHrs: '3h 40m – 7h',
        distanceKm: 160,
        departureTimes: ['9:20', '10:20', '16:50', '18:20', '22:20', '23:00'],
        returnTimes: [],
        busType: ['Non-AC', 'AC Sleeper'],
        dhakaCounters: ['Technical, Dhaka'],
        destCounters: ['Pabna Bus Terminal'],
        stops: [
          { name: 'Dhaka (Technical)', bnName: 'ঢাকা (টেকনিক্যাল)', type: 'origin' },
          { name: 'Sirajganj', bnName: 'সিরাজগঞ্জ', arrivalTime: '', type: 'stop' },
          { name: 'Ullapara', bnName: 'উল্লাপাড়া', arrivalTime: '', type: 'stop' },
          { name: 'Shahjadpur', bnName: 'শাহজাদপুর', arrivalTime: '', type: 'stop' },
          { name: 'Baghabari', bnName: 'বাঘাবাড়ী', arrivalTime: '', type: 'stop' },
          { name: 'Bera', bnName: 'বেড়া', arrivalTime: '', type: 'stop' },
          { name: 'Kashinathpur', bnName: 'কাশিনাথপুর', arrivalTime: '', type: 'stop' },
          { name: 'Pabna', bnName: 'পাবনা', arrivalTime: '', type: 'destination' },
        ],
      },
    ],
    policy: STD_POLICY,
  ...
  // ── PABNA EXPRESS ───────────────────────────────────────────────────────────
  {
    id: 'pabna_express',
    name: 'Pabna Express',
    bnName: 'পাবনা এক্সপ্রেস',
    shortName: 'Pabna Express',
    logo: '#f97316',
    rating: 3.9,
    website: '',
    phone: ['01700-000001'],
    headquarters: 'Pabna',
    fleetSize: '40+',
    busTypes: ['Hino-1J Non-AC', 'Volvo AC/RM-2'],
    coverage: 'Dhaka ⇄ Pabna, Dhaka ⇄ Ishwardi',
    routes: [
      {
        id: 'dhaka_pabna',
        from: 'Dhaka', fromBn: 'ঢাকা',
        ...
        durationHrs: '5h – 6h',
        distanceKm: 160,
        departureTimes: ['06:00', '07:00', '08:00', '09:00', '11:30', '14:00', '17:00', '19:00', '22:00', '23:30'],
        returnTimes: [],
        busType: ['Non-AC', 'AC Sleeper'],
        dhakaCounters: ['Sayedabad, Dhaka', 'Abdullahpur, Dhaka'],
        destCounters: ['Pabna Bus Terminal'],
        stops: [
          { name: 'Dhaka (Sayedabad / Abdullahpur)', bnName: 'ঢাকা (সায়েদাবাদ/আবদুল্লাহপুর)', type: 'origin' },
          { name: 'Sirajganj', bnName: 'সিরাজগঞ্জ', arrivalTime: '', type: 'stop' },
          { name: 'Baghabari', bnName: 'বাঘাবাড়ী', arrivalTime: '', type: 'stop' },
          { name: 'Bera', bnName: 'বেড়া', arrivalTime: '', type: 'stop' },
          { name: 'Kashinathpur', bnName: 'কাশিনাথপুর', arrivalTime: '', type: 'stop' },
  ...
  // ── SARKAR ──────────────────────────────────────────────────────────────────
  {
    ...
    headquarters: 'Pabna',
    fleetSize: '20+',
    busTypes: ['Hino Non-AC'],
    coverage: 'Dhaka ⇄ Pabna corridor',
    routes: [
      {
        id: 'dhaka_pabna',
        from: 'Dhaka', fromBn: 'ঢাকা',
        ...
        returnTimes: [],
        busType: ['Non-AC'],
        dhakaCounters: ['Gabtoli, Dhaka', 'Kalyanpur, Dhaka'],
        destCounters: ['Pabna Bus Terminal'],
        stops: [
          { name: 'Dhaka (Gabtoli)', bnName: 'ঢাকা (গাবতলী)', type: 'origin' },
          { name: 'Sirajganj', bnName: 'সিরাজগঞ্জ', arrivalTime: '', type: 'stop' },
  ...
  // ── ALHAMRA PARIBAHAN ────────────────────────────────────────────────────────
  {
    id: 'alhamra_paribahan',
    name: 'Alhamra Paribahan',
    bnName: 'আলহামরা পরিবহন',
    shortName: 'Alhamra',
    logo: '#8b5cf6',
    rating: 3.8,
    website: '',
    ...
    headquarters: 'Dhaka',
    fleetSize: '30+',
    busTypes: ['Hino 1J Non-AC', 'Hino RN AC'],
    coverage: 'Dhaka ⇄ Pabna, Dhaka ⇄ Gaibandha, Dhaka ⇄ Bogura',
    routes: [
      {
        id: 'dhaka_pabna',
        from: 'Dhaka', fromBn: 'ঢাকা',
        to: 'Pabna', toBn: 'পাবনা',
        fareNonAC: "৳400", fareAC: "৳1200",
        durationHrs: '5h – 7h',
        distanceKm: 160,
        departureTimes: ['11:30', '16:30', '20:30'],
        returnTimes: [],
        busType: ['Non-AC', 'AC'],
        dhakaCounters: ['Sirajganj route terminals, Dhaka'],
        destCounters: ['Pabna Bus Terminal'],
        stops: [
          { name: 'Dhaka', bnName: 'ঢাকা', type: 'origin' },
          { name: 'Sirajganj', bnName: 'সিরাজগঞ্জ', arrivalTime: '', type: 'stop' },
          { name: 'Ullapara', bnName: 'উল্লাপাড়া', arrivalTime: '', type: 'stop' },
          { name: 'Shahjadpur', bnName: 'শাহজাদপুর', arrivalTime: '', type: 'stop' },
          { name: 'Pabna', bnName: 'পাবনা', arrivalTime: '', type: 'destination' },
