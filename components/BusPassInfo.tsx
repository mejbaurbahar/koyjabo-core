...
const passes = [
  {
    ...
    icon: '🚇',
    price: '৳200 (রিচার্জযোগ্য)',
    where: 'মেট্রো স্টেশন কাউন্টার',
    benefits: [
    ...
    eligibility: 'সবার জন্য — বিশেষ প্রতিবন্ধী ও প্রবীণ ছাড় আছে',
    link: 'https://dmtcl.gov.bd',
    linkLabel: 'DMTCL অফিসিয়াল সাইট',
  },
  {
    ...
    icon: '🚌',
    price: '৳500–৳1,200 (রুট অনুযায়ী)',
    where: 'বিআরটিসি অফিস, বাস টার্মিনাল',
    benefits: [
    ...
    eligibility: 'সবার জন্য, শিক্ষার্থীদের আইডি কার্ড লাগবে',
    link: 'https://brtc.gov.bd',
    linkLabel: 'বিআরটিসি অফিসিয়াল সাইট',
  },
  {
    ...
    icon: '🎓',
    price: 'মূল ভাড়ার ৫০%',
    where: 'স্থানীয় পরিবহন অফিস বা বাস কাউন্টার',
    benefits: [
      'সব সরকারি বাসে ৫০% ছাড়',
      'মেট্রোতে স্টুডেন্ট Rapid Pass দিয়ে ছাড়',
      'বাৎসরিক বা মাসিক ভিত্তিতে নেওয়া যায়',
    ],
    eligibility: 'স্কুল / কলেজ / বিশ্ববিদ্যালয়ের শিক্ষার্থী (আইডি কার্ড বাধ্যতামূলক)',
    link: null,
    linkLabel: '',
  },
  {
...
const howToUse = [
  { step: '১', text: 'নিকটস্থ বিআরটিসি বা মেট্রো অফিসে যান' },
  { step: '২', text: 'প্রয়োজনীয় কাগজপত্র নিয়ে যান (NID/আইডি কার্ড, ছবি)' },
  { step: '৩', text: 'ফর্ম পূরণ করুন ও নির্ধারিত ফি জমা দিন' },
  { step: '৪', text: 'কার্ড বা পাস সংগ্রহ করুন (৩–৭ কর্মদিবস)' },
  { step: '৫', text: 'যাত্রার সময় কার্ড দেখিয়ে বা ট্যাপ করে বোর্ড করুন' },
];
  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 dark:bg-slate-900 overflow-hidden">
      ...
      <div className="flex items-center gap-3 p-4 bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-gray-800 shrink-0">
        ...
        <div>
          <h1 className="text-lg font-bold text-gray-900 dark:text-white">বাস পাস / কার্ড তথ্য</h1>
          <p className="text-xs text-gray-500 dark:text-gray-400">Bus Pass & Transit Card Information</p>
        </div>
      </div>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto p-4 space-y-4">
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-2xl p-4">
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm text-blue-800 dark:text-blue-200">ঢাকায় পরিবহন পাস ব্যবহার করে প্রতি মাসে ৳500–৳2,000 পর্যন্ত সাশ্রয় করা সম্ভব।</p>
          </div>
        </div>
          ...
          <div key={pass.name} className="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-sm border border-gray-100 dark:border-gray-700">
            <div className={`bg-gradient-to-r ${pass.color} p-4 text-white`}>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-lg">{pass.bnName}</h3>
                  <p className="text-white/80 text-sm">{pass.name}</p>
                </div>
              </div>
              <div className="mt-3 flex items-center gap-2 bg-white/20 rounded-lg px-3 py-1.5 w-fit">
                <CreditCard className="w-4 h-4" />
                <span className="font-bold text-sm">{pass.price}</span>
              </div>
            </div>

            <div className="p-4 space-y-3">
              <div>
                <p className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1">সুবিধাসমূহ</p>
              ...
              <div className="bg-gray-50 dark:bg-slate-700/50 rounded-xl p-3">
                <p className="text-xs font-bold text-gray-500 dark:text-gray-400 mb-1">কোথায় পাবেন</p>
                <p className="text-sm text-gray-700 dark:text-gray-300">{pass.where}</p>
              </div>
              <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-3">
                <p className="text-xs font-bold text-amber-700 dark:text-amber-400 mb-1">যোগ্যতা</p>
                <p className="text-sm text-amber-800 dark:text-amber-300">{pass.eligibility}</p>
              </div>
              {pass.link && (
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl p-4 shadow-sm border border-gray-100 dark:border-gray-700">
          <h3 className="font-bold text-gray-900 dark:text-white mb-4">কীভাবে পাস পাবেন?</h3>
          <div className="space-y-3">
            {howToUse.map((item) => (
              <div key={item.step} className="flex items-start gap-3">
                ...
                <p className="text-sm text-gray-700 dark:text-gray-300 pt-1">{item.text}</p>
              </div>
            ))}
          </div>
        </div>
