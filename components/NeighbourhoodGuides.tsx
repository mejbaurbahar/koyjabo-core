...
const GUIDES = [
  ...
  // ─── Rangpur ────────────────────────────────────────────────────────────────
  {
    ...
    descriptionEn: 'Coolest division of northern Bangladesh. Rich in tea and vegetable production.',
    metroAccess: ['কোনো মেট্রো নেই'],
    metroAccessEn: ['No metro'],
    buses: ['ঢাকা-রংপুর ইন্টারসিটি বাস ও ট্রেন', 'লোকাল বাস ও সিএনজি'],
    busesEn: ['Dhaka-Rangpur intercity bus and train', 'Local bus and CNG'],
    tips: ['শীতকালে পর্যটনের জন্য সেরা', 'কুড়িগ্রাম হয়ে তিস্তার পাড়ে যান', 'দিনাজপুরের সুপারি মিষ্টান্ন বিখ্যাত'],
    tipsEn: ['Best for tourism in winter', 'Go to the Teesta riverbank via Kurigram', 'Dinajpur supari mithai is famous'],
    landmarks: ['কান্তজিউ মন্দির (দিনাজপুর)', 'তিস্তা নদী', 'রামসাগর দিঘি'],
    landmarksEn: ['Kantaji Temple (Dinajpur)', 'Teesta River', 'Ramsagar Dighi'],
    icon: '❄️',
  },
  {
