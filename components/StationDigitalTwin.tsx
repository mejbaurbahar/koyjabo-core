...
const StationDigitalTwin: React.FC<StationDigitalTwinProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-[600] flex items-center justify-center p-4 sm:p-8 bg-kj-panel/90 backdrop-blur-md animate-in fade-in duration-300">
            <div className="relative w-full max-w-6xl aspect-video bg-black rounded-3xl overflow-hidden shadow-2xl border border-white/10 flex flex-col">
                ...
                <div className="absolute top-0 left-0 right-0 z-10 p-6 flex justify-between items-start pointer-events-none">
                    <div className="pointer-events-auto">
                        <div className="flex items-center gap-3 mb-1">
                            <div className="px-2 py-0.5 bg-kj-primary text-white text-[10px] font-bold rounded uppercase tracking-widest">Digital Twin</div>
                ...
                {isLoading && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center bg-kj-panel gap-4">
                        <Loader2 className="w-12 h-12 text-kj-primary animate-spin" />
                        <div className="flex flex-col items-center">
                            ...
                            <div className="w-48 h-1.5 bg-white/10 rounded-full overflow-hidden">
                                <div 
                                    className="h-full bg-kj-primary transition-all duration-300"
                ...
                {error && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center bg-kj-panel p-8 text-center">
                        ...
                        <button 
                            ...
                            className="px-6 py-2 bg-white text-kj-text font-bold rounded-full hover:bg-emerald-400 transition-colors"
                        >
                            Try Again
                        </button>
                    </div>
                ...
                {!isLoading && !error && (
                    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-1.5 p-2 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl">
                        <div className="flex items-center gap-1 px-3 py-1.5 bg-white/10 rounded-xl border border-white/5">
                            <Move className="w-3.5 h-3.5 text-kj-primary" />
                        ...
                        <button className="w-8 h-8 flex items-center justify-center bg-white/20 hover:bg-kj-primary text-white rounded-lg transition-all">
                ...
                {/* Info Badge */}
                <div className="absolute bottom-6 left-6 p-4 bg-kj-primary/10 backdrop-blur-md rounded-2xl border border-kj-primary/20 hidden sm:block">
                    <div className="flex items-start gap-3">
                        <div className="w-10 h-10 bg-kj-primary rounded-xl flex items-center justify-center text-white shadow-lg shadow-emerald-500/40">
                            <Smartphone className="w-5 h-5" />
                        </div>
                        <div>
                            <div className="text-[10px] font-bold text-kj-primary uppercase tracking-widest mb-0.5">Capturing Method</div>
