...
const IntercityHub: React.FC<IntercityHubProps> = ({ onBack, language, onSearch }) => {
  ...
  return (
    <div className="flex-1 min-h-0 overflow-y-auto overscroll-y-contain touch-pan-y bg-kj-bg" style={{ WebkitOverflowScrolling: 'touch' }}>
      <div className="px-4 md:px-10 py-5 md:py-8 max-w-4xl mx-auto pb-nav-safe">
