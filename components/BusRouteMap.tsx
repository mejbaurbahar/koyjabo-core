  ...
  return (
    <div className="relative z-0 isolate w-full rounded-b-2xl overflow-hidden bg-kj-chip-bg" style={{ height: 310 }}>
      ...
      <div className="absolute bottom-10 left-3 z-[500] flex flex-col items-start gap-1.5">
        {showLayers && (
          <div className="bg-white/95 dark:bg-kj-chip-bg/95 backdrop-blur-sm rounded-xl border border-kj-line border-kj-line shadow-xl p-3 w-44 mb-1 animate-in slide-in-from-bottom-2 fade-in duration-150">
            <div className="flex justify-between items-center mb-2 pb-1.5 border-b border-kj-line border-kj-line">
            ...
            <div className="space-y-1.5">
              {[
                { key: 'metro', label: 'Metro Rail', active: showMetro, set: setShowMetro, color: 'from-kj-primary to-kj-neon-violet', Icon: Train },
