...
const TRAIN_ROUTES = [
    { from: "Dhaka", to: "Chattogram", trains: ["Subarna Express", "Sonar Bangla Express (Non-Stop)", "Turna Express (Night)", "Mohanagar Goduli", "Chattala Express", "Dhaka Mail", "Karnaphuli Express"], fare: "400-1500" },
    { from: "Dhaka", to: "Sylhet", trains: ["Upaban Express", "Jayantika Express", "Kalni Express", "Parabat Express", "Surma Mail"], fare: "350-1200" },
    { from: "Dhaka", to: "Rajshahi", trains: ["Silk City", "Padma Express", "Dhumketu Express", "Banalata Express (Non-Stop)"], fare: "350-1200" },
    { from: "Dhaka", to: "Khulna", trains: ["Sundarban Express", "Chitra Express"], fare: "505-1500" },
    ...
    { from: "Dhaka", to: "Noakhali", trains: ["Upakul Express", "Noakhali Express"], fare: "350-1100" },
    ...
    { from: "Dhaka", to: "Mymensingh", trains: ["Tista Express", "Agnibina Express", "Brahmaputra Express", "Jamuna Express", "Mohanganj Express", "Haor Express", "Balaka Commuter", "Mymensingh Express"], fare: "150-600" },
    { from: "Dhaka", to: "Netrokona", trains: ["Haor Express", "Mohanganj Express"], fare: "250-800" },
    ...
    { from: "Dhaka", to: "Brahmanbaria", trains: ["Titas Commuter", "Mahanagar Express", "Almost all Sylhet/Ctg trains stop here"], fare: "120-600" },
    { from: "Dhaka", to: "Jamalpur", trains: ["Tista Express", "Jamuna Express", "Agnibina Express", "Jamalpur Express"], fare: "200-600" },
    { from: "Dhaka", to: "Faridpur", trains: ["Madhumati Express", "Benapole Express (via Bhanga)"], fare: "300-800" },
    ...
    { from: "Dhaka", to: "Chapainawabganj", trains: ["Banalata Express"], fare: "400-1300" },
    { from: "Dhaka", to: "Joydebpur", trains: ["Turag Express", "Joydebpur Commuter", "Balaka Commuter", "All Northern/Eastern trains"], fare: "50-150" },
    { from: "Dhaka", to: "Narayanganj", trains: ["Narayanganj Commuter (Hourly)"], fare: "15-50" },
    { from: "Dhaka", to: "Bhairab", trains: ["Titas Commuter", "Isha Khan Express"], fare: "100-300" },
    { from: "Dhaka", to: "Gopalganj", trains: ["Tungipara Express"], fare: "300-900" },
    { from: "Dhaka", to: "Dewanganj", trains: ["Tista Express", "Brahmaputra Express", "Dewanganj Commuter"], fare: "200-700" },
    { from: "Dhaka", to: "Kolkata", trains: ["Maitree Express"], fare: "2500-4500" },
    { from: "Chattogram", to: "Sylhet", trains: ["Paharika Express", "Udayan Express", "Jalalabad Express (Mail)"], fare: "400-1200" },
    { from: "Chattogram", to: "Chandpur", trains: ["Meghna Express", "Sagarika Express (Mail)"], fare: "150-500" },
    { from: "Chattogram", to: "Mymensingh", trains: ["Bijoy Express"], fare: "400-1000" },
    { from: "Chattogram", to: "Dhaka", trains: ["Subarna Express", "Sonar Bangla Express", "Turna Express"], fare: "400-1500" },
    { from: "Chattogram", to: "Noakhali", trains: ["Sagarika Express"], fare: "100-400" },
    { from: "Chattogram", to: "Nazirhat", trains: ["Nazirhat Commuter"], fare: "30-100" },
    { from: "Chattogram", to: "Dohazari", trains: ["Dohazari Commuter"], fare: "30-100" },
    ...
    { from: "Khulna", to: "Chilahati", trains: ["Mahananda Express"], fare: "200-700" },
    { from: "Khulna", to: "Kolkata", trains: ["Bandhan Express"], fare: "1500-3000" },
    ...
    { from: "Rajshahi", to: "Goalanda Ghat", trains: ["Madhumati Express"], fare: "200-600" },
    ...
    { from: "Chuadanga", to: "Dhaka", trains: ["Chitra Express", "Sundarban Express", "Benapole Express"], fare: "400-1200" },
    { from: "Santahar", to: "Dinajpur", trains: ["Dolonchapa Express"], fare: "100-300" },
    { from: "Mymensingh", to: "Mohanganj", trains: ["Larea/Local trains"], fare: "50-150" },
    { from: "Laksam", to: "Noakhali", trains: ["Noakhali Express", "Laksam Commuter"], fare: "40-150" },
    { from: "Laksam", to: "Chandpur", trains: ["Chandpur Commuter"], fare: "30-120" },
    { from: "Akhaura", to: "Sylhet", trains: ["Jalalabad Express", "Surma Mail"], fare: "100-400" },
    { from: "Parbatipur", to: "Rajshahi", trains: ["Barendra Express", "Titumir Express"], fare: "150-500" },
    { from: "Parbatipur", to: "Dhaka", trains: ["Ekota Express", "Drutojan Express", "Panchagarh Express", "Nilsagar Express"], fare: "400-1500" },
    { from: "Ishwardi", to: "Dhaka", trains: ["All Northern/Western trains stop here"], fare: "250-1000" },
    { from: "Bogra", to: "Dhaka", trains: ["Rangpur Express", "Lalmoni Express", "Kurigram Express (From nearby Santahar)"], fare: "350-1200" },
];
