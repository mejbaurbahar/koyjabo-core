...
const TRAIN_ROUTES = [
    ...
    { from: "Benapole", to: "Dhaka", trains: ["Benapole Express", "Rupashi Bangla Express (via Padma Bridge/Fast)"], fare: "455-1500" },
    { from: "Benapole", to: "Mongla", trains: ["Mongla Commuter"], fare: "100-300" },
    { from: "Khulna", to: "Mongla", trains: ["Mongla Commuter"], fare: "50-150" },
    { from: "Jashore", to: "Narail", trains: ["Rupashi Bangla Express"], fare: "100-300" },
    { from: "Jashore", to: "Dhaka", trains: ["Rupashi Bangla Express", "Benapole Express", "Sundarban Express", "Chitra Express"], fare: "400-1400" },
