  ...
  const renderAbout = () => (
    <div className="flex flex-col h-full bg-white dark:bg-slate-900 p-6 md:p-12 pt-6 md:pt-24 md:pb-12 overflow-y-auto overflow-x-hidden w-full max-w-full pb-nav-safe">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <EzoicAd placeholderId={102} className="my-6 hidden md:block" />
  ...
  const renderFAQ = () => (
    <div className="flex flex-col h-full bg-white dark:bg-slate-900 p-6 md:p-12 pt-6 md:pt-24 md:pb-12 overflow-y-auto w-full pb-nav-safe">
      <div className="max-w-3xl mx-auto">
        ...
        <EzoicAd placeholderId={105} className="my-6 hidden md:block" />
  ...
  const renderBusDetails = () => {
   ...
   `}>
        ...
        <div className="p-4 pt-5 space-y-4 bg-slate-50 dark:bg-slate-900 pb-4 overflow-visible">
          ...
          <EzoicAd placeholderId={103} className="my-6 hidden md:block pointer-events-none" />
          ...
          {filteredBuses.map((bus, busIdx) => {
            ...
            return (
              <React.Fragment key={bus.id}>
                {busIdx > 0 && busIdx % 7 === 0 && (
                  <EzoicAd placeholderId={104} className="my-4 hidden md:block" />
                )}
                <div
