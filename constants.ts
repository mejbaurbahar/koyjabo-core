...
export const STATIONS: Record<string, Station> = {
  ...
  vatiapara:      { id: 'vatiapara',      name: 'Vatiapara',             bnName: 'ভাটিয়াপাড়া',          lat: 23.0512, lng: 89.8924 },
  mollahat:       { id: 'mollahat',       name: 'Mollahat',              bnName: 'মোল্লাহাট',             lat: 22.8214, lng: 89.7938 },
  fakirhat:       { id: 'fakirhat',       name: 'Fakirhat',              bnName: 'ফকিরহাট',               lat: 22.7380, lng: 89.8530 },
  bhanga:         { id: 'bhanga',         name: 'Bhanga',                bnName: 'ভাঙ্গা',                lat: 23.2208, lng: 89.6913 },
  phultala:       { id: 'phultala',       name: 'Phultala',              bnName: 'ফুলতলা',                lat: 22.8073, lng: 89.4921 },
  ...
  // ── Sylhet corridor stops ──────────────────────────────────────────────────
  shaistaganj:    { id: 'shaistaganj',    name: 'Shaistaganj',           bnName: 'শায়েস্তাগঞ্জ',          lat: 24.3965, lng: 91.3885 },
  ashuganj:       { id: 'ashuganj',       name: 'Ashuganj',              bnName: 'আশুগঞ্জ',               lat: 23.9898, lng: 90.9820 },
  velanagar:      { id: 'velanagar',      name: 'Velanagar',             bnName: 'বেলানগর',               lat: 24.1200, lng: 90.8100 },
  madhabpur:      { id: 'madhabpur',      name: 'Madhabpur',             bnName: 'মাধবপুর',               lat: 24.1800, lng: 91.2200 },
  // ── Rangpur/Dinajpur corridor stops ──────────────────────────────────────
  gobindaganj:    { id: 'gobindaganj',    name: 'Gobindaganj',           bnName: 'গোবিন্দগঞ্জ',           lat: 25.0110, lng: 89.3666 },
  palashbari:     { id: 'palashbari',     name: 'Palashbari',            bnName: 'পলাশবাড়ী',              lat: 25.1826, lng: 89.3799 },
  birampur:       { id: 'birampur',       name: 'Birampur',              bnName: 'বিরামপুর',               lat: 25.4990, lng: 89.1729 },
  ghoraghat:      { id: 'ghoraghat',      name: 'Ghoraghat',             bnName: 'ঘোড়াঘাট',               lat: 25.0210, lng: 89.2200 },
  fulbari_din:    { id: 'fulbari_din',    name: 'Fulbari (Dinajpur)',     bnName: 'ফুলবাড়ী (দিনাজপুর)',    lat: 25.9018, lng: 89.0232 },
  mokamtola:      { id: 'mokamtola',      name: 'Mokamtola',             bnName: 'মোকামতলা',               lat: 24.9100, lng: 89.3500 },
  // ── Rajshahi corridor stops ───────────────────────────────────────────────
  ...
  chuknagar:      { id: 'chuknagar',      name: 'Chuknagar',             bnName: 'চুকনগর',                lat: 22.8985, lng: 89.2738 },
  // ── Barisal corridor stops ────────────────────────────────────────────────
  tekerhat:       { id: 'tekerhat',       name: 'Tekerhat',              bnName: 'টেকেরহাট',               lat: 23.2300, lng: 89.9100 },
...
export const BUS_DATA: BusRoute[] = [
  ...
  },
  {
    ...
    stops: ['sayedabad', 'gopalganj', 'mollahat', 'khulna'],
    type: 'AC',
    hours: '5:45 AM - 11:00 PM',
  },
  {
    id: 'shohagh_barisal',
  ...
  // ── Dhaka→Khulna corridor operators (from Shohoz live data) ─────────────
  {
    id: 'tungipara_khulna_1',
    name: 'Tungipara Express (Dhaka-Khulna Non-AC)',
    bnName: 'টুঙ্গিপাড়া এক্সপ্রেস (ঢাকা-খুলনা)',
    routeString: 'Dhaka ⇄ Khulna',
    stops: ['sayedabad', 'gulistan', 'vatiapara', 'gopalganj', 'mollahat', 'khulna'],
    type: 'Sitting',
    hours: '5:15 AM - 11:55 PM',
  },
  {
    id: 'tungipara_khulna_2',
    name: 'Tungipara Express (Dhaka-Khulna AC)',
    bnName: 'টুঙ্গিপাড়া এক্সপ্রেস (ঢাকা-খুলনা, এসি)',
    routeString: 'Dhaka ⇄ Khulna',
    stops: ['sayedabad', 'gulistan', 'vatiapara', 'gopalganj', 'khulna'],
    type: 'AC',
    hours: '6:55 AM - 9:15 PM',
  },
  {
    id: 'dola_khulna',
    name: 'Dola Paribahan (Dhaka-Khulna)',
    bnName: 'দোলা পরিবহন (ঢাকা-খুলনা)',
    routeString: 'Dhaka ⇄ Khulna',
    stops: ['sayedabad', 'gulistan', 'gopalganj', 'fakirhat', 'khulna', 'phultala'],
    type: 'Sitting',
    hours: '5:20 AM - 10:30 PM',
  },
  {
    id: 'emad_khulna_1',
    name: 'Emad Paribahan (Dhaka-Khulna Non-AC)',
    bnName: 'ইমাদ পরিবহন (ঢাকা-খুলনা)',
    routeString: 'Dhaka ⇄ Khulna',
    stops: ['sayedabad', 'gulistan', 'gopalganj', 'mollahat', 'fakirhat', 'khulna', 'phultala'],
    type: 'Sitting',
    hours: '6:00 AM - 11:00 PM',
  },
  {
    id: 'emad_khulna_2',
    name: 'Emad Paribahan (Dhaka-Khulna AC)',
    bnName: 'ইমাদ পরিবহন (ঢাকা-খুলনা, এসি)',
    routeString: 'Dhaka ⇄ Khulna',
    stops: ['sayedabad', 'gulistan', 'gopalganj', 'mollahat', 'fakirhat', 'khulna'],
    type: 'AC',
    hours: '8:00 AM - 9:30 PM',
  },
  {
    id: 'hanif_khulna_gopalganj',
    name: 'Hanif Enterprise (Dhaka-Khulna via Gopalganj)',
    bnName: 'হানিফ এন্টারপ্রাইজ (ঢাকা-খুলনা, গোপালগঞ্জ)',
    routeString: 'Dhaka ⇄ Khulna',
    stops: ['gulistan', 'bhanga', 'gopalganj', 'mollahat', 'fakirhat', 'khulna'],
    type: 'Sitting',
    hours: '7:00 AM - 11:00 PM',
  },
  {
    id: 'hanif_khulna_jessore',
    name: 'Hanif Enterprise (Dhaka-Khulna via Magura-Jessore)',
    bnName: 'হানিফ এন্টারপ্রাইজ (ঢাকা-খুলনা, মাগুরা-যশোর)',
    routeString: 'Dhaka ⇄ Khulna',
    stops: ['sayedabad', 'magura', 'jessore', 'khulna'],
    type: 'Sitting',
    hours: '7:00 AM - 11:30 PM',
  },
  {
    id: 'diganta_khulna',
    name: 'Diganta Paribahan (Dhaka-Khulna)',
    bnName: 'দিগন্ত পরিবহন (ঢাকা-খুলনা)',
    routeString: 'Dhaka ⇄ Khulna',
    stops: ['sayedabad', 'magura', 'jessore', 'khulna'],
    type: 'Sitting',
  ...
  {
    id: 'master_travels_khulna',
    name: 'Master Travels (Dhaka-Khulna)',
    bnName: 'মাস্টার ট্রাভেলস (ঢাকা-খুলনা)',
    routeString: 'Dhaka ⇄ Khulna',
    stops: ['abdullahpur', 'sayedabad', 'gopalganj', 'khulna'],
    type: 'Sitting',
    hours: '9:30 AM',
  },
  ...
  {
    id: 'shyamoli_sylhet',
    name: 'Shyamoli Paribahan (Dhaka-Sylhet)',
    bnName: 'শ্যামলী পরিবহন (ঢাকা-সিলেট)',
    routeString: 'Dhaka ⇄ Sylhet',
    stops: ['mohakhali_bus_stand', 'ashuganj', 'shaistaganj', 'sylhet'],
    type: 'AC',
    hours: '6:30 AM - 11:45 PM',
  },
  {
    id: 'bilash_sylhet',
    name: 'Bilash Paribahan (Dhaka-Sylhet)',
    bnName: 'বিলাস পরিবহন (ঢাকা-সিলেট)',
    routeString: 'Dhaka ⇄ Sylhet',
    stops: ['sayedabad', 'velanagar', 'madhabpur', 'shaistaganj', 'sylhet'],
    type: 'AC',
    hours: '5:15 AM - 11:59 PM',
  },
  {
    id: 'ena_sylhet',
    name: 'Ena Transport (Dhaka-Sylhet)',
    bnName: 'এনা ট্রান্সপোর্ট (ঢাকা-সিলেট)',
    routeString: 'Dhaka ⇄ Sylhet',
    stops: ['sayedabad', 'narsingdi', 'shaistaganj', 'sylhet'],
    type: 'AC',
    hours: '5:00 AM - 11:45 PM',
  },
  // Chittagong corridor
  {
    id: 'soudia_chittagong',
    name: 'Soudia Coach Service (Dhaka-Chittagong)',
    bnName: 'সৌদিয়া কোচ সার্ভিস (ঢাকা-চট্টগ্রাম)',
    routeString: 'Dhaka ⇄ Chittagong',
    stops: ['sayedabad', 'comilla', 'feni', 'chittagong'],
    type: 'AC',
    hours: '7:00 AM - 11:30 PM',
  ...
  {
    id: 'al_madani_chittagong',
    name: 'Al-Madani Exclusive (Dhaka-Chittagong)',
    bnName: 'আল-মাদানী এক্সক্লুসিভ (ঢাকা-চট্টগ্রাম)',
    routeString: 'Dhaka ⇄ Chittagong',
    stops: ['kamalapur', 'sayedabad', 'comilla', 'feni', 'chittagong'],
    type: 'AC',
    hours: '9:00 PM - 11:00 PM',
  },
  // Rangpur corridor
  {
    id: 'rongdhonu_rangpur',
    name: 'Rongdhonu Express (Dhaka-Rangpur)',
    bnName: 'রংধনু এক্সপ্রেস (ঢাকা-রংপুর)',
    routeString: 'Dhaka ⇄ Rangpur',
    stops: ['sayedabad', 'bogra', 'mokamtola', 'gobindaganj', 'palashbari', 'rangpur'],
    type: 'AC',
    hours: '12:30 PM - 11:55 PM',
  },
  {
    id: 'orin_rangpur',
    name: 'Orin Travels (Dhaka-Rangpur)',
    bnName: 'ওরিন ট্রাভেলস (ঢাকা-রংপুর)',
    routeString: 'Dhaka ⇄ Rangpur',
    stops: ['mohakhali_bus_stand', 'mokamtola', 'gobindaganj', 'palashbari', 'rangpur'],
    type: 'AC',
    hours: '6:00 AM - 11:45 PM',
  },
  {
    id: 'sr_travels_rangpur',
    name: 'S.R Travels (Dhaka-Rangpur)',
    bnName: 'এস.আর ট্রাভেলস (ঢাকা-রংপুর)',
    routeString: 'Dhaka ⇄ Rangpur',
    stops: ['sayedabad', 'bogra', 'mokamtola', 'gobindaganj', 'palashbari', 'rangpur'],
    type: 'AC',
    hours: '6:30 AM - 11:45 PM',
  ...
  // Dinajpur corridor
  {
    id: 'shyamoli_dinajpur',
    name: 'Shyamoli Paribahan (Dhaka-Dinajpur)',
    bnName: 'শ্যামলী পরিবহন (ঢাকা-দিনাজপুর)',
    routeString: 'Dhaka ⇄ Dinajpur',
    stops: ['sayedabad', 'gobindaganj', 'ghoraghat', 'birampur', 'fulbari_din', 'dinajpur'],
    type: 'AC',
    hours: '7:30 AM - 10:45 PM',
  },
  // Rajshahi corridor
  {
    id: 'akota_rajshahi',
    name: 'Akota Transport (Dhaka-Rajshahi)',
    bnName: 'আকোতা ট্রান্সপোর্ট (ঢাকা-রাজশাহী)',
    routeString: 'Dhaka ⇄ Rajshahi',
    stops: ['mohakhali_bus_stand', 'sirajganj', 'natore', 'puthia', 'rajshahi'],
    type: 'AC',
    hours: '5:00 AM - 11:59 PM',
  },
  {
    id: 'ktc_hanif_rajshahi',
    name: 'KTC Hanif (Dhaka-Rajshahi)',
    bnName: 'কেটিসি হানিফ (ঢাকা-রাজশাহী)',
    routeString: 'Dhaka ⇄ Rajshahi',
    stops: ['sayedabad', 'bonpara', 'natore', 'puthia', 'rajshahi'],
    type: 'Sitting',
    hours: '6:15 AM - 11:55 PM',
  },
  // Barisal corridor
  {
    id: 'labiba_barisal',
    name: 'LABIBA Classic (Dhaka-Barishal)',
    bnName: 'লাবিবা ক্লাসিক (ঢাকা-বরিশাল)',
    routeString: 'Dhaka ⇄ Barishal',
    stops: ['abdullahpur', 'sayedabad', 'gopalganj', 'barisal'],
    type: 'Sitting',
    hours: '5:30 AM - 11:55 PM',
  },
  {
    id: 'shyamoli_barisal',
    name: 'Shyamoli Paribahan (Dhaka-Barishal)',
    bnName: 'শ্যামলী পরিবহন (ঢাকা-বরিশাল)',
    routeString: 'Dhaka ⇄ Barishal',
    stops: ['sayedabad', 'tekerhat', 'barisal'],
    type: 'Sitting',
    hours: '5:00 AM - 11:00 PM',
  },
  // Satkhira corridor
  {
    id: 'satkhira_line',
    name: 'Satkhira Line (Dhaka-Satkhira)',
    bnName: 'সাতক্ষীরা লাইন (ঢাকা-সাতক্ষীরা)',
    routeString: 'Dhaka ⇄ Satkhira',
    stops: ['sayedabad', 'magura', 'jessore', 'navaron', 'kalaroa', 'satkhira'],
    type: 'AC',
    hours: '5:30 AM - 11:30 PM',
  },
  {
    id: 'jamuna_line_satkhira',
    name: 'Jamuna Line Paribahan (Dhaka-Satkhira)',
    bnName: 'যমুনা লাইন পরিবহন (ঢাকা-সাতক্ষীরা)',
    routeString: 'Dhaka ⇄ Satkhira',
    stops: ['sayedabad', 'narail', 'jessore', 'jhikargacha', 'navaron', 'kalaroa', 'satkhira'],
    type: 'Sitting',
    hours: '8:00 AM - 10:45 PM',
  },
  // Jhenaidah corridor
  {
    id: 'royal_express_jhenaidah',
    name: 'Royal Express (Dhaka-Jhenaidah)',
    bnName: 'রয়েল এক্সপ্রেস (ঢাকা-ঝিনাইদহ)',
    routeString: 'Dhaka ⇄ Jhenaidah',
    stops: ['sayedabad', 'magura', 'jhenaidah'],
    type: 'AC',
    hours: '6:00 AM - 11:30 PM',
  },
  // Bogura corridor
  {
    id: 'manik_express_bogura',
    name: 'Manik Express (Dhaka-Bogura)',
    bnName: 'মানিক এক্সপ্রেস (ঢাকা-বগুড়া)',
    routeString: 'Dhaka ⇄ Bogura',
    stops: ['sayedabad', 'bogra'],
    type: 'AC',
    hours: '7:00 AM - 11:59 PM',
  },
  {
    id: 'rongdhonu_bogura',
    name: 'Rongdhonu Express (Dhaka-Bogura)',
    bnName: 'রংধনু এক্সপ্রেস (ঢাকা-বগুড়া)',
    routeString: 'Dhaka ⇄ Bogura',
    stops: ['sayedabad', 'bogra'],
    type: 'AC',
    hours: '12:30 PM - 11:55 PM',
  ...
  // Sunamganj corridor
  {
    id: 'shyamoli_sunamganj',
    name: 'Shyamoli Paribahan (Dhaka-Sunamganj)',
    bnName: 'শ্যামলী পরিবহন (ঢাকা-সুনামগঞ্জ)',
    routeString: 'Dhaka ⇄ Sunamganj',
  ...
  {
    id: 'imperial_express_moulvibazar',
    name: 'Imperial Express (Dhaka-Moulvibazar)',
    bnName: 'ইম্পেরিয়াল এক্সপ্রেস (ঢাকা-মৌলভিবাজার)',
    routeString: 'Dhaka ⇄ Moulvibazar',
    stops: ['arambagh', 'sayedabad', 'velanagar', 'shaistaganj', 'sreemangal', 'moulvibazar'],
    type: 'AC',
    hours: '10:30 PM, 10:45 PM',
  },
  {
    id: 'comfort_line_faridpur',
    name: 'Comfort Line Pvt Ltd (Dhaka-Faridpur)',
    bnName: 'কমফোর্ট লাইন (ঢাকা-ফরিদপুর)',
    routeString: 'Dhaka ⇄ Faridpur',
    stops: ['gabtoli', 'faridpur'],
    type: 'Sitting',
    hours: '6:45 AM, 8:45 AM, 9:45 AM, 8:45 PM',
  },
  {
    id: 'labiba_kuakata',
    name: 'LABIBA Classic (Dhaka-Kuakata)',
    bnName: 'লাবিবা ক্লাসিক (ঢাকা-কুয়াকাটা)',
    routeString: 'Dhaka ⇄ Kuakata',
    stops: ['gabtoli', 'sayedabad', 'barisal', 'patuakhali', 'kuakata'],
    type: 'Sitting',
    hours: '5:30 AM - 11:55 PM',
  },
  {
    id: 'emad_kuakata',
    name: 'Emad Paribahan (Dhaka-Kuakata)',
    bnName: 'ইমাদ পরিবহন (ঢাকা-কুয়াকাটা)',
    routeString: 'Dhaka ⇄ Kuakata',
    stops: ['abdullahpur', 'sayedabad', 'barisal', 'patuakhali', 'kuakata'],
    type: 'AC',
    hours: '8:30 PM, 9:30 PM',
  },
  {
    id: 'bilash_moulvibazar',
    name: 'Bilash Paribahan (Dhaka-Moulvibazar)',
    bnName: 'বিলাস পরিবহন (ঢাকা-মৌলভিবাজার)',
    routeString: 'Dhaka ⇄ Moulvibazar',
    stops: ['sayedabad', 'velanagar', 'madhabpur', 'shaistaganj', 'sreemangal', 'moulvibazar'],
    type: 'AC',
    hours: '5:15 AM - 11:50 PM',
  },
  {
